...
G = zeros(2,1) 
G[0,0] = Eq1.subs([(dq1, 0), (dq2, 0), (ddq1, 0), (ddq2, 0)]).simplify()
G[1,0] = Eq2.subs([(dq1, 0), (dq2, 0), (ddq1, 0), (ddq2, 0)]).simplify()
print('-------------------------\nG:\n',G)

M = zeros(2,2) 
M[0,0] = Eq1.subs([(g, 0), (dq1, 0), (dq2, 0), (ddq2, 0), (ddq1, 1)]).simplify()
M[0,1] = Eq1.subs([(g, 0), (dq1, 0), (dq2, 0), (ddq1, 0), (ddq2, 1)]).simplify()
M[1,0] = Eq2.subs([(g, 0), (dq1, 0), (dq2, 0), (ddq2, 0), (ddq1, 1)]).simplify()
M[1,1] = Eq2.subs([(g, 0), (dq1, 0), (dq2, 0), (ddq1, 0), (ddq2, 1)]).simplify()
M = simplify(M)
print('-------------------------\nM:\n', M)

C = zeros(2,2) 
C[0,0] = Eq1.subs([(ddq1, 0), (ddq2, 0), (g, 0), (dq2, 0), (dq1, 1)]).simplify()
C[0,1] = Eq1.subs([(ddq1, 0), (ddq2, 0), (g, 0), (dq1, 0), (dq2, 1)]).simplify()
C[1,0] = Eq2.subs([(ddq1, 0), (ddq2, 0), (g, 0), (dq2, 0), (dq1, 1)]).simplify()
C[1,1] = Eq2.subs([(ddq1, 0), (ddq2, 0), (g, 0), (dq1, 0), (dq2, 1)]).simplify()
C = simplify(C)
print('-------------------------\nC:\n', C)
print('-------------------------')
